const gameDetails = [
...

  {
    ...
    screenshots: [],
    itchUrl:     "https://loden-campbell.itch.io/against-the-grain",
    engine:      "Unity",
    teamSize:    4,
...

  {
    ...
    screenshots: [],
    itchUrl:     "https://loden-campbell.itch.io/on-par",
...

  {
    ...
    screenshots: [],
    itchUrl:     "https://loden-campbell.itch.io/desolate-remnants",
    engine:      "Unity",
    teamSize:    5,
    role:        "CCC & Systems Engineer",
...

  {
    ...
    screenshots: [],
    itchUrl:     "https://loden-campbell.itch.io/the-cave",
    engine:      "Twine",
    teamSize:    1,
    role:        "Solo Developer",
